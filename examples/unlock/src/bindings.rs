...
pub trait Guest {
    /// Unlock script is run by calling `for_great_justice()` function.
        ...
        pub mod stack {
            ...
            pub fn push(key: &str) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "comrade:hypervisor/stack@0.1.0")]
                    extern "C" {
                        #[link_name = "push"]
...
A\x04\x01B\x04\x01@\x01\x03keys\x01\0\x04\0\x04push\x01\0\x01@\0\0s\x04\0\x03pop\
\x01\x01\x03\x01\x1ecomrade:hypervisor/stack@0.1.0\x05\0\x01@\0\x01\0\x04\0\x11f\
or-great-justice\x01\x01\x04\x01\x15scripts:unlock/unlock\x04\0\x0b\x0c\x01\0\x06\
