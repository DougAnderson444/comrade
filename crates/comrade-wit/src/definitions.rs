...
pub fn into_comp_value(value: comrade_core::Value) -> Result<wasm_component_layer::Value, String> {
    match value {
...
pub fn into_core_value(value: wasm_component_layer::Value) -> Result<comrade_core::Value, String> {
    match value {
