            ...
            pub mod foo {
                ...
                unsafe impl _rt::WasmResource for Bar {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]comrade:core/foo")]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_comrade_core_foo_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "comrade:core/foo#[constructor]bar"] unsafe extern "C" fn
                        ...
                        "comrade:core/foo#[method]bar.value"] unsafe extern "C" fn
                        ...
                        #[doc(hidden)] #[export_name = "comrade:core/foo#[dtor]bar"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_comrade_core_foo_cabi;
            }
        }
    }
}
...
macro_rules! __export_example_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::comrade::core::foo::__export_comrade_core_foo_cabi!($ty with_types_in
        $($path_to_types_root)*:: exports::comrade::core::foo);
    };
}
#[doc(inline)]
pub(crate) use __export_example_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:comrade:core:example:encoded world"]
#[doc(hidden)]
...
random-byte\x01\x01\x03\0\x11comrade:core/host\x05\0\x01B\x07\x04\0\x03bar\x03\x01\
\x01i\0\x01@\x01\x05valuez\0\x01\x04\0\x10[constructor]bar\x01\x02\x01h\0\x01@\x01\
\x04self\x03\0z\x04\0\x11[method]bar.value\x01\x04\x04\0\x10comrade:core/foo\x05\
\x01\x04\0\x14comrade:core/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0G\x09\
