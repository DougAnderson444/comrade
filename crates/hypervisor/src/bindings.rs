    ...
    pub mod comrade {
        ...
        pub mod hypervisor {
            ...
            pub mod check {
                ...
                pub unsafe fn _export_signature_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    let result1 = T::signature(_rt::string_lift(bytes0));
                    match result1 {
                        true => 1,
                        false => 0,
                    }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_preimage_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    let result1 = T::preimage(_rt::string_lift(bytes0));
                    match result1 {
                        true => 1,
                        false => 0,
                    }
                ...
                pub trait Guest {
                    ...
                    fn signature(key: _rt::String) -> bool;
                    /// Checks the hash preimage
                    fn preimage(key: _rt::String) -> bool;
                }
                #[doc(hidden)]
